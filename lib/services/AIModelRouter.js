...
class AIModelRouter {
  ...
  getStats() {
    const localSuccessRate = this.stats.localModelRequests > 0 ? 
      ((this.stats.localModelRequests - this.stats.localModelErrors) / this.stats.localModelRequests * 100).toFixed(1) : 0;
    
    const claudeSuccessRate = this.stats.claudeApiRequests > 0 ? 
      ((this.stats.claudeApiRequests - this.stats.claudeApiErrors) / this.stats.claudeApiRequests * 100).toFixed(1) : 0;
